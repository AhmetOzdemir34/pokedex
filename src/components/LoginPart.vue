<template>
    <div>
        ...
        <div class="inputs">
            <input type="text" v-model="email" class="inps inps1" :placeholder="getUsernamePlaceholder" />
            <input type="password" v-model="password" class="inps inps2" :placeholder="getPasswordPlaceholder" />
